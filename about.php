  ...
  <div class="container">
    <div class="row">
          ...
          <ol>
            ...
            <li>Take the right to remain anonymous seriously</li>
            <li>Take our users security seriously</li>
          </ol>
          <h4>We don't:</h4>
          <ol>
            <li>Require any identification to register</li>
            <li>Require you to confirm your account via methods such as secondary email or sms</li>
            <li>Keep server logs, except for the ones required to maintain a good service, all this data is destroyed at the earliest possible opportunity</li>
            <li>Keep any info on your browser, IP or logins</li>
          </ol>
          <h4>We won't:</h4>
          <ol>
            <li>Arbitraily hand over logs (we can't, we don't keep any)</li>
